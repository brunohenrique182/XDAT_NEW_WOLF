...
function OnClickButton(string Name)
{
	switch(Name)
	{
		case "connectDethroneToggle_btn":
			...
			break;
		case "Help1_btn":
			Class'InterfaceClassic.HelpWnd'.static.ShowHelp(63, 2);
			break;
		case "Help2_btn":
			Class'InterfaceClassic.HelpWnd'.static.ShowHelp(63, 3);
			break;
		default:
			break;
	}
...
function ParsePacket_S_EX_DETHRONE_CONNECT_CASTLE()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_DETHRONE_CONNECT_CASTLE(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_DETHRONE_DISCONNECT_CASTLE()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_DETHRONE_DISCONNECT_CASTLE(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_DETHRONE_SERVER_INFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_DETHRONE_SERVER_INFO(packet))
	{
		return;
	}
...
function API_C_EX_DETHRONE_SERVER_INFO()
{
	...
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(717, stream);
...
function API_C_EX_DETHRONE_CONNECT_CASTLE()
{
	...
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(727, stream);
...
function API_C_EX_DETHRONE_DISCONNECT_CASTLE()
{
	...
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(728, stream);
