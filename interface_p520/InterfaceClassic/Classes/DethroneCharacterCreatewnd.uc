...
function SetAssets()
{
	uicontrolDialogAssetScr = Class'InterfaceClassic.UIControlDialogAssets'.static.InitScript(GetWindowHandle((m_Windowname $ ".AssetGroup.UIControlDialogAsset")));
...
function API_C_EX_DETHRONE_INFO()
{
	...
	packet.cDummy = 0;
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_DETHRONE_INFO(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(715, stream);
	return;
}
...
function API_C_EX_DETHRONE_ENTER()
{
	...
	packet.cDummy = 0;
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_DETHRONE_ENTER(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(723, stream);
	return;
}
...
function API_C_EX_DETHRONE_LEAVE()
{
	...
	packet.cDummy = 0;
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_DETHRONE_LEAVE(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(724, stream);
	return;
}
...
function API_C_EX_DETHRONE_CHECK_NAME(string _name)
{
	...
	packet.sName = _name;
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_DETHRONE_CHECK_NAME(stream, packet))
	{
		return;
	}
	Debug("API_C_EX_DETHRONE_CHECK_NAME");
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(725, stream);
	return;
}
...
function API_C_EX_DETHRONE_CHANGE_NAME()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_DETHRONE_CHANGE_NAME(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(726, stream);
	return;
}
...
function Handle_S_EX_DETHRONE_INFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_DETHRONE_INFO(packet))
	{
		return;
	}
	_name = packet.sName;
...
function Handle_S_EX_DETHRONE_CHECK_NAME()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_DETHRONE_CHECK_NAME(packet))
	{
		return;
	}
...
function Handle_S_EX_DETHRONE_CHANGE_NAME()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_DETHRONE_CHANGE_NAME(packet))
	{
		return;
	}
