...
function ParsePacket_S_EX_PENALTY_ITEM_RESTORE()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_PENALTY_ITEM_RESTORE(packet))
	{
		return;
	}
...
function API_C_EX_PENALTY_ITEM_LIST(optional int nReserved)
{
	...
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(697, stream);
...
function API_C_EX_PENALTY_ITEM_RESTORE(int nItemDBID, optional int bByAdena)
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_PENALTY_ITEM_RESTORE(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(698, stream);
