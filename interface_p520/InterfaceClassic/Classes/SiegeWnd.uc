...
function API_C_EX_CASTLEWAR_OBSERVER_START()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_CASTLEWAR_OBSERVER_START(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(616, stream);
	return;
}
