...
function OnLoad()
{
	...
	uiTimer._time = 1;
	uiTimerHelp = Class'InterfaceClassic.L2UITimer'.static.Inst()._MakeTimerObject();
...
function API_C_EX_PVPBOOK_SHARE_REVENGE_REQ_SHARE_REVENGEINFO(string Kill, int Type)
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_PVPBOOK_SHARE_REVENGE_REQ_SHARE_REVENGEINFO(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(693, stream);
	return;
}
...
function C_EX_PVPBOOK_SHARE_REVENGE_LIST()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_PVPBOOK_SHARE_REVENGE_LIST(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(692, stream);
	return;
}
...
function C_EX_PVPBOOK_SHARE_REVENGE_KILLER_LOCATION(string enemyUserName)
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_PVPBOOK_SHARE_REVENGE_KILLER_LOCATION(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(694, stream);
	return;
}
...
function C_EX_PVPBOOK_SHARE_REVENGE_TELEPORT_TO_KILLER(string enemyUserName)
{
	...
	packet.sKilledUserName = UserInfo.Name;
	packet.sKillUserName = enemyUserName;
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_PVPBOOK_SHARE_REVENGE_TELEPORT_TO_KILLER(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(695, stream);
	return;
}
...
function C_EX_PVPBOOK_SHARE_REVENGE_SHARED_TELEPORT_TO_KILLER()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_PVPBOOK_SHARE_REVENGE_SHARED_TELEPORT_TO_KILLER(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(696, stream);
	return;
}
...
function S_EX_PVPBOOK_SHARE_REVENGE_LIST()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_PVPBOOK_SHARE_REVENGE_LIST(packet))
	{
		return;
	}
...
function S_EX_PVPBOOK_SHARE_REVENGE_KILLER_LOCATION()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_PVPBOOK_SHARE_REVENGE_KILLER_LOCATION(packet))
	{
		return;
	}
	return;
