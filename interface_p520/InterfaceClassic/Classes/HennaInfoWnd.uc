...
{
	needItemListEquip = new Class'InterfaceClassic.UIControlNeedItemList';
	...
	selectNeedItemListEquip = new Class'InterfaceClassic.UIControlNeedItemList';
	...
	needItemListUnEquip = new Class'InterfaceClassic.UIControlNeedItemList';
	...
	selectNeedItemListUnEquip = new Class'InterfaceClassic.UIControlNeedItemList';
...
function ParsePacket_S_EX_NEW_HENNA_EQUIP()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_NEW_HENNA_EQUIP(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_NEW_HENNA_UNEQUIP()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_NEW_HENNA_UNEQUIP(packet))
	{
		return;
	}
...
function API_C_EX_NEW_HENNA_EQUIP(int nSlotID, int nItemSid, int nCostItemId)
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_NEW_HENNA_EQUIP(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(747, stream);
...
function API_C_EX_NEW_HENNA_UNEQUIP(int nCostItemId)
{
	...
	packet.nCostItemId = nCostItemId;
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_NEW_HENNA_UNEQUIP(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(748, stream);
