...
function ShowDeleteDialog(int Index, string Msg)
{
	...
	Class'InterfaceClassic.UICommonAPI'.static.DialogSetReservedInt(Index);
	Class'InterfaceClassic.UICommonAPI'.static.DialogShowWithTarget(DialogModalType_Modal, DialogType_OKCancel, Msg, m_Windowname);
	return;
}
...
function ShowRestoreDialog(int SelectedCharacter)
{
	...
	Class'InterfaceClassic.UICommonAPI'.static.DialogSetReservedInt(SelectedCharacter);
	Class'InterfaceClassic.UICommonAPI'.static.DialogShowWithTarget(DialogModalType_Modal, DialogType_OKCancel, GetSystemMessage(1555), m_Windowname);
	return;
}
...
function HandleDialogResult(bool bOK)
{
	...
	Reserved = Class'InterfaceClassic.UICommonAPI'.static.DialogGetReservedInt();
	switch(DlgID)
	{
		case 1:
