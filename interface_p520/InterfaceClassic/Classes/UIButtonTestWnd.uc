...
function DiceInit()
{
	diceTweenObj0 = new Class'InterfaceClassic.L2UITweenObject';
	...
	diceTweenObj1 = new Class'InterfaceClassic.L2UITweenObject';
...
{
	Class'InterfaceClassic.OnscreenEffectViewPortWnd'.static.Inst()._playEffectViewWithText(1.0000000, 1999.0000000, "LineageEffect2.ui_screen_message_flow", 0, 0, 0, -7, 0, 3000, 500, "야야야야야야야야\\n safsafsadfasfdsadafssddasfdafsdfas", GTColor().White);  // EN?: Yaya yaya yaya yaya\\ n safsafsadfasfdsadafssddasfdafsdfas
	return;
}

function Ontest2ButtonClick()
{
	Class'InterfaceClassic.OnscreenEffectViewPortWnd'.static.Inst()._playEffectViewWithText(1.0000000, 500.0000000, "LineageEffect2.ui_screen_message02_flow", 0, 0, 0, -3, 0, 3000, 500, "축하합니다. 성공입니다!", GTColor().Yellow, GetItemInfoByClassID(1));  // EN?: *Note: You haven’t registered yet.
	return;
}

function Ontest3ButtonClick()
{
	Class'InterfaceClassic.OnscreenEffectViewPortWnd'.static.Inst()._playEffectViewWithText_Texture(getTextureInfo("L2UI_EPIC.subjugation_silent_valley", "OnscreenEffectViewPortWnd.ScreenTextBox", "TopCenter", "TopCenter", 0, -60, 387, 180), 1.0000000, 500.0000000, "LineageEffect2.ui_screen_message03_flow", 0, 0, 0, -3, 0, 3000, 1000, "위험한 영역 입니다.", GTColor().Red);  // EN?: This is dangerous territory.
	return;
}

function Ontest4ButtonClick()
{
	Class'InterfaceClassic.OnscreenEffectViewPortWnd'.static.Inst()._playEffectViewWithText_Texture(getTextureInfo("L2UI_CT1.OnScreenMessageWnd.OnScreenMessageWnd_DF_Win10_siege", "OnscreenEffectViewPortWnd.ScreenTextBox", "TopCenter", "TopCenter", 0, -29, 425, 90), 1.0000000, 500.0000000, "LineageEffect2.ui_upgrade_succ", 0, 0, 0, 2, 0, 3000, 1000, "축하합니다. 성공입니다.", GTColor().Yellow, GetItemInfoByClassID(93864));  // EN?: Congratulations, you've made it.
	return;
}
...
{
	Class'InterfaceClassic.OnscreenEffectViewPortWnd'.static.Inst()._playEffectViewWithText_Texture(getTextureInfo("L2UI_EPIC.CollectionSystemWnd.KeyItemcol_A_00", "OnscreenEffectViewPortWnd.ScreenTextBox", "TopCenter", "TopCenter", 0, -200, 233, 523), 1.0000000, 500.0000000, "LineageEffect2.y_kn_summon_cubic_fire_body", 0, 0, 0, -3, 0, 3000, 1000, "처치 성공 아이템 획득!", GTColor().White, , 2);  // EN?: Successful Kill Items Earned!
	return;
}
...
function initControl()
{
	...
	scr = Class'InterfaceClassic.UIControlNumberInputSteper'.static.InitScript(GetWindowHandle((m_hOwnerWnd.m_WindowNameWithFullPath $ ".NumberInputSteper")));
