...
function ParsePacket_S_EX_DETHRONE_RANKING_INFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_DETHRONE_RANKING_INFO(packet))
	{
		return;
	}
...
function API_C_EX_DETHRONE_RANKING_INFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_DETHRONE_RANKING_INFO(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(716, stream);
