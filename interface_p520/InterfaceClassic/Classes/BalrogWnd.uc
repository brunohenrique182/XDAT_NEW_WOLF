...
function ParsePacket_S_EX_BALROGWAR_SHOW_UI()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_BALROGWAR_SHOW_UI(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_BALROGWAR_GET_REWARD()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_BALROGWAR_GET_REWARD(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_BALROGWAR_BOSSINFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_BALROGWAR_BOSSINFO(packet))
	{
		return;
	}
...
function API_C_EX_BALROGWAR_TELEPORT()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_BALROGWAR_TELEPORT(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(779, stream);
...
function API_C_EX_BALROGWAR_GET_REWARD()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_BALROGWAR_GET_REWARD(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(782, stream);
...
function API_C_EX_BALROGWAR_SHOW_UI()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_BALROGWAR_SHOW_UI(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(780, stream);
