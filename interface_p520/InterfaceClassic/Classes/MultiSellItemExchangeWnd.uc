...
function InitControls()
{
	...
	exchangeDialog = Class'InterfaceClassic.UIControlDialogAssets'.static.InitScript(exchangeDialogWnd);
	...
	tabGroupButtonAsset = Class'InterfaceClassic.UIControlGroupButtonAssets'.static._InitScript(GetWindowHandle((ownerFullPath $ ".TopGroupButtonAsset")));
	...
	inputItemScript = Class'InterfaceClassic.UIControlNumberInput'.static.InitScript(GetWindowHandle((ownerFullPath $ ".Bottom_Wnd.InputItemWnd")));
	...
	searchTextInput = Class'InterfaceClassic.UIControlTextInput'.static.InitScript(GetWindowHandle((ownerFullPath $ ".ItemExchange_Wnd.ItemFind_Wnd.TextInput")));
