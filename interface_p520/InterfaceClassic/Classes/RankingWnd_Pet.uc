...
function ParsePacket_S_EX_PET_RANKING_MY_INFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_PET_RANKING_MY_INFO(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_PET_RANKING_LIST()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_PET_RANKING_LIST(packet))
	{
		return;
	}
...
function API_C_EX_PET_RANKING_MY_INFO(int nPetServerID)
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_PET_RANKING_MY_INFO(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(682, stream);
...
function API_C_EX_PET_RANKING_LIST(int nPetServerID, int nIndex)
{
	...
	packet.nCollarID = nPetServerID;
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_PET_RANKING_LIST(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(683, stream);
