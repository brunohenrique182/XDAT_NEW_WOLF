...
function Load()
{
	myRewardNeedItemList = new Class'InterfaceClassic.UIControlNeedItemList';
	...
	serverRewardNeedItemList = new Class'InterfaceClassic.UIControlNeedItemList';
...
function ParsePacket_S_EX_DETHRONE_GET_REWARD()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_DETHRONE_GET_REWARD(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_DETHRONE_PREV_SEASON_INFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_DETHRONE_PREV_SEASON_INFO(packet))
	{
		return;
	}
...
function API_C_EX_DETHRONE_PREV_SEASON_INFO()
{
	...
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(721, stream);
...
function API_C_EX_DETHRONE_GET_REWARD()
{
	...
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(722, stream);
	Reward_Btn.DisableWindow();
