...
function ParsePacket_S_EX_PVP_RANKING_MY_INFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_PVP_RANKING_MY_INFO(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_PVP_RANKING_LIST()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_PVP_RANKING_LIST(packet))
	{
		return;
	}
...
function API_C_EX_PVP_RANKING_LIST()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_PVP_RANKING_LIST(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(663, stream);
...
function API_C_EX_PVP_RANKING_MY_INFO()
{
	...
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(662, stream);
