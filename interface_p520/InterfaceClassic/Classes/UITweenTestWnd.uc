...
event OnClickButton(string Name)
{
	switch(Name)
	{
		...
		case "SaveList":
			...
			Class'InterfaceClassic.UIListNoteWnd'.static.Inst()._SetString(GetTweenName(ETweenParamType(tweenTypeComboBox.GetSelectedNum())));
...
function MaketweenObjectFormString(string param)
{
	...
	switch(Type)
	{
		...
		case "shake":
			...
			break;
		case "Twinkle":
			twinkleObject = new Class'InterfaceClassic.L2UITweenTwinkleObject';
			...
			Class'InterfaceClassic.L2UITween'.static.Inst()._AddTweenTwinlkle(GetWindowHandle(targetString), (twinkleObject.twinkleNum / 10.0000000), (twinkleObject.Position / 10.0000000), twinkleObject.Duration, twinkleObject.minAlpha, twinkleObject.maxAlpha, twinkleObject.gab);
			break;
		default:
			break;
	}
