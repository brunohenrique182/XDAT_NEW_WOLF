...
function UpdateExpandWnd()
{
	if((_itemAutoPeelInfo.isExpand == true))
	{
		...
		Class'InterfaceClassic.ItemAutoPeelExpandWnd'.static.Inst().m_hOwnerWnd.ShowWindow();
	}
	else
	{
		expandBtn.ShowWindow();
		Class'InterfaceClassic.ItemAutoPeelExpandWnd'.static.Inst().m_hOwnerWnd.HideWindow();
	}
	return;
}
...
function UpdateUIControls()
{
	...
	Class'InterfaceClassic.ItemAutoPeelExpandWnd'.static.Inst().UpdateUIControls();
	return;
}
...
function ShowSimpleInven(bool isShow)
{
	if((isShow == true))
	{
		Class'InterfaceClassic.ItemAutoPeelInvenWnd'.static.Inst().m_hOwnerWnd.ShowWindow();
	}
	else
	{
		Class'InterfaceClassic.ItemAutoPeelInvenWnd'.static.Inst().m_hOwnerWnd.HideWindow();
	}
	return;
}
...
function SetCountDialogModal(bool isModal)
{
	if((isModal == true))
	{
		Class'InterfaceClassic.ItemAutoPeelInvenWnd'.static.Inst().m_hOwnerWnd.DisableWindow();
		Class'InterfaceClassic.ItemAutoPeelExpandWnd'.static.Inst().ShowDisableWnd(true);
		Me.DisableWindow();
	}
	else
	{
		Class'InterfaceClassic.ItemAutoPeelInvenWnd'.static.Inst().m_hOwnerWnd.EnableWindow();
		Class'InterfaceClassic.ItemAutoPeelExpandWnd'.static.Inst().ShowDisableWnd(false);
		Me.EnableWindow();
	}
	UpdateUIControls();
	return;
...
function Rq_C_EX_READY_ITEM_AUTO_PEEL(int itemServerID)
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_READY_ITEM_AUTO_PEEL(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(789, stream);
	return;
}
...
function Rq_C_EX_REQUEST_ITEM_AUTO_PEEL(int itemServerID, INT64 remainPeelCnt, INT64 totalPeelCnt)
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_REQUEST_ITEM_AUTO_PEEL(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(790, stream);
	return;
}
...
function Rq_C_EX_STOP_ITEM_AUTO_PEEL()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_STOP_ITEM_AUTO_PEEL(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(791, stream);
	return;
}
...
function Rs_S_EX_READY_ITEM_AUTO_PEEL()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_READY_ITEM_AUTO_PEEL(packet))
	{
		return;
	}
...
function Rs_S_EX_RESULT_ITEM_AUTO_PEEL()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_RESULT_ITEM_AUTO_PEEL(packet))
	{
		return;
	}
	IsSuccess = bool(packet.bResult);
...
function Rs_S_EX_STOP_ITEM_AUTO_PEEL()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_STOP_ITEM_AUTO_PEEL(packet))
	{
		return;
	}
	IsSuccess = bool(packet.bResult);
