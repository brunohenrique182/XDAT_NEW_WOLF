...
function UpdateSkillInfoControls()
{
	...
	Class'InterfaceClassic.L2Util'.static.GetEllipsisString(validSkillInfo.SkillName, 140);
...
function Nt_S_EX_ACQUIRE_PET_SKILL_RESULT()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_ACQUIRE_PET_SKILL_RESULT(packet))
	{
		return;
	}
