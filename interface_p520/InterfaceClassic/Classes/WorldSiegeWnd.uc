...
event OnShow()
{
	...
	worldSiegeInfoMCWWndScript = Class'InterfaceClassic.WorldSiegeInfoMCWWnd'.static.Inst();
...
function Handle_S_EX_WORLDCASTLEWAR_CASTLE_SIEGE_INFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_WORLDCASTLEWAR_CASTLE_SIEGE_INFO(packet))
	{
		return;
	}
...
function API_C_EX_WORLDCASTLEWAR_TELEPORT(int TeleportID)
{
	...
	if(Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_WORLDCASTLEWAR_TELEPORT(stream, packet))
	{
		Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(739, stream);
	}
	return;
}
...
function API_C_EX_WORLDCASTLEWAR_OBSERVER_START()
{
	...
	if(Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_WORLDCASTLEWAR_OBSERVER_START(stream, packet))
	{
		Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(740, stream);
	}
	return;
}
...
function API_C_EX_WORLDCASTLEWAR_CASTLE_SIEGE_INFO()
{
	...
	packet.nCastleID = GetCastleIDSelected();
	if(Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_WORLDCASTLEWAR_CASTLE_SIEGE_INFO(stream, packet))
	{
		Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(733, stream);
	}
	return;
}
...
function API_C_EX_WORLDCASTLEWAR_RETURN_TO_ORIGIN_PEER()
{
	...
	packet.nCastleID = GetCastleIDSelected();
	if(Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_WORLDCASTLEWAR_RETURN_TO_ORIGIN_PEER(stream, packet))
	{
		Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(731, stream);
	}
	return;
}
...
function BuildiSet()
{
	...
	{
		l2UITimeStruct = Class'InterfaceClassic.UIData'.static.Inst().GetCurrentRealLocalTime();
		worldSiegeStartCommand = ((((("//set_siege aden_castle" @ string(l2UITimeStruct.nYear)) @ Class'InterfaceClassic.UIData'.static.Inst().Int2Str(l2UITimeStruct.nMonth)) @ Class'InterfaceClassic.UIData'.static.Inst().Int2Str(l2UITimeStruct.nDay)) @ Class'InterfaceClassic.UIData'.static.Inst().Int2Str(l2UITimeStruct.nHour)) @ Class'InterfaceClassic.UIData'.static.Inst().Int2Str((l2UITimeStruct.nMin + StartTime)));
		worldSiegeEndCommand = ((((("//set_siege_end aden_castle" @ string(l2UITimeStruct.nYear)) @ Class'InterfaceClassic.UIData'.static.Inst().Int2Str(l2UITimeStruct.nMonth)) @ Class'InterfaceClassic.UIData'.static.Inst().Int2Str(l2UITimeStruct.nDay)) @ Class'InterfaceClassic.UIData'.static.Inst().Int2Str(l2UITimeStruct.nHour)) @ Class'InterfaceClassic.UIData'.static.Inst().Int2Str((l2UITimeStruct.nMin + EndTime)));
