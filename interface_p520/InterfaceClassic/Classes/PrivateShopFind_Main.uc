...
function ParsePacket_S_EX_PRIVATE_STORE_SEARCH_STATISTICS()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_PRIVATE_STORE_SEARCH_STATISTICS(packet))
	{
		return;
	}
...
function API_C_EX_PRIVATE_STORE_SEARCH_STATISTICS()
{
	...
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(742, stream);
