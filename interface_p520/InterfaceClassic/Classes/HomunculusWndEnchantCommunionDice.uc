...
function Handle_S_EX_RESET_HOMUNCULUS_SKILL_RESULT()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_RESET_HOMUNCULUS_SKILL_RESULT(packet))
	{
		return;
	}
	if((packet.Type == 1))
...
function Handle_S_EX_ENCHANT_HOMUNCULUS_SKILL_RESULT()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_ENCHANT_HOMUNCULUS_SKILL_RESULT(packet))
	{
		return;
	}
	if((packet.Type == 0))
