...
function bool API_C_EX_STEADY_BOX_LOAD()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_STEADY_BOX_LOAD(stream, packet))
	{
		return false;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(678, stream);
}
...
function bool API_C_EX_TIMER_CHECK()
{
	...
	packet.nType = 0;
	packet.nIndex = 0;
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_TIMER_CHECK(stream, packet))
	{
		return false;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(677, stream);
}
...
function bool API_C_EX_STEADY_OPEN_SLOT(int Id)
{
	...
	packet.nSlotID = (Id + 1);
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_STEADY_OPEN_SLOT(stream, packet))
	{
		return false;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(679, stream);
}
...
function bool API_C_EX_STEADY_OPEN_BOX(int Id, INT64 Amount)
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_STEADY_OPEN_BOX(stream, packet))
	{
		return false;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(680, stream);
}
...
function bool API_C_EX_STEADY_GET_REWARD(int Id)
{
	...
	packet.nSlotID = (Id + 1);
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_STEADY_GET_REWARD(stream, packet))
	{
		return false;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(681, stream);
}
...
function Handle_S_EX_STEADY_BOX_UI_INIT()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_STEADY_BOX_UI_INIT(packet))
	{
		return;
	}
...
function Handle_S_EX_TIMER_CHECK()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_TIMER_CHECK(packet))
	{
		return;
	}
...
function Handle_S_EX_STEADY_ALL_BOX_UPDATE()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_STEADY_ALL_BOX_UPDATE(packet))
	{
		return;
	}
...
function Handle_S_EX_STEADY_ONE_BOX_UPDATE()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_STEADY_ONE_BOX_UPDATE(packet))
	{
		return;
	}
...
function Handle_S_EX_STEADY_BOX_REWARD()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_STEADY_BOX_REWARD(packet))
	{
		return;
	}
