...
function Clear()
{
	...
	{
		Class'InterfaceClassic.L2UITween'.static.Inst()._KillTwinkleWithWnd(Pet_Hungry_Alarm);
	}
	...
	if(GetPetInfo(Info))
	{
		...
		if((Fatigue <= 0))
		{
			if((bPetHungryAlarmFlag == false))
			{
				...
				Class'InterfaceClassic.L2UITween'.static.Inst()._AddTweenTwinlkle(Pet_Hungry_Alarm, -1.0000000, 0.5000000, 1000.0000000);
			}
		}
