...
{
	uicontrolFindTextInputScr = Class'InterfaceClassic.UIControlTextInput'.static.InitScript(GetWindowHandle((m_Windowname $ ".FindTextInput")));
	...
	uicontrolExecptionTextInputScr = Class'InterfaceClassic.UIControlTextInput'.static.InitScript(GetWindowHandle((m_Windowname $ ".execptionTextInput")));
...
{
	return (((("<tr><td width=140 align=right>" $ Title) $ "</td><td width=1></td><td width=150 align=left>") $ htmlfontAdd((" " $ Desc), Class'InterfaceClassic.L2UIColor'.static.Inst()._Color2ZeroX(Class'InterfaceClassic.L2UIColor'.static.Inst().Sandrift))) $ "</td></tr>");
}
...
function int InsertRecordFindTreeList(string fullNameString, string a_Param, int Id, string IconName, optional bool canSkillEnchant)
{
	...
	Record.LVDataList[1].TextColor = Class'InterfaceClassic.L2UIColor'.static.Inst().VIOLET01;
...
function openDialogNumpad(INT64 Num)
{
	...
	Class'InterfaceClassic.UICommonAPI'.static.DialogSetID(10000);
	Class'InterfaceClassic.UICommonAPI'.static.DialogSetEditType("number");
	Class'InterfaceClassic.UICommonAPI'.static.DialogSetParamInt64(Num);
