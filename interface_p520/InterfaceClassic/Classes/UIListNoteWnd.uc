...
function Initialize()
{
	...
	Editor = Class'InterfaceClassic.UIControlSimpleListEditor'.static.InitScript(GetWindowHandle((m_hOwnerWnd.m_WindowNameWithFullPath $ ".UIControlSimpleListEditorExpands")));
...
function _Show(WindowHandle _owner, optional string iniName, optional string sessionName, optional string KeyName)
{
	...
	Owner = _owner;
	Class'InterfaceClassic.L2Util'.static.Inst().windowAnchorToSide(Owner, m_hOwnerWnd, 10);
