...
function OnShow()
{
	...
	UIControlNeedItemSelectMultiItem = Class'InterfaceClassic.UIControlNeedItemSelectMultiItems'.static._InitScript(GetWindowHandle("UIDevTestWnd.UIControlNeedItemSelectMultiItem"));
	...
	UIControlNeedItemSelectMultiItemDesc = Class'InterfaceClassic.UIControlNeedItemSelectMultiItems'.static._InitScript(GetWindowHandle("UIDevTestWnd.UIControlNeedItemSelectMultiItemDesc"));
