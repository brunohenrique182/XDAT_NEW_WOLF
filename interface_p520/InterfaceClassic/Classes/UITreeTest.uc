...
function Initialize()
{
	...
	ROOTNAME = "root";
	treeInstance1 = new Class'InterfaceClassic.UITreeUtil';
	treeInstance2 = new Class'InterfaceClassic.UITreeUtil';
	treeInstance3 = new Class'InterfaceClassic.UITreeUtil';
	treeInstance4 = new Class'InterfaceClassic.UITreeUtil';
	treeInstance5 = new Class'InterfaceClassic.UITreeUtil';
	treeInstance6 = new Class'InterfaceClassic.UITreeUtil';
	return;
}
