...
function API_C_EX_SET_STATUS_BONUS()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_SET_STATUS_BONUS(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(611, stream);
	return;
}
...
function API_C_EX_RESET_STATUS_BONUS()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_RESET_STATUS_BONUS(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(612, stream);
	return;
}
