...
function Rs_S_EX_WRANKING_FESTIVAL_SIDEBAR_INFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_WRANKING_FESTIVAL_SIDEBAR_INFO(packet))
	{
		return;
	}
...
function Rs_S_EX_WRANKING_FESTIVAL_INFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_WRANKING_FESTIVAL_INFO(packet))
	{
		return;
	}
...
function Rs_S_EX_WRANKING_FESTIVAL_MYINFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_WRANKING_FESTIVAL_MYINFO(packet))
	{
		return;
	}
...
function Rq_C_EX_WRANKING_FESTIVAL_OPEN()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_WRANKING_FESTIVAL_OPEN(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(798, stream);
	return;
}
...
function Rq_C_EX_WRANKING_FESTIVAL_INFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_WRANKING_FESTIVAL_INFO(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(797, stream);
	return;
}
...
function Rq_C_EX_WRANKING_FESTIVAL_BUY(int buyID, int ItemNum)
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_WRANKING_FESTIVAL_BUY(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(799, stream);
	return;
}
...
function Rq_C_EX_WRANKING_FESTIVAL_BONUS(array<int> nPoints)
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_WRANKING_FESTIVAL_BONUS(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(800, stream);
	return;
}
...
function Rq_C_EX_WRANKING_FESTIVAL_RANKING(int RankingType)
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_WRANKING_FESTIVAL_RANKING(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(801, stream);
	return;
}
...
function Rq_C_EX_WRANKING_FESTIVAL_MY_RECEIVED_BONUS()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_WRANKING_FESTIVAL_MY_RECEIVED_BONUS(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(802, stream);
	return;
}
...
function Rs_S_EX_WRANKING_FESTIVAL_BUY()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_WRANKING_FESTIVAL_BUY(packet))
	{
		return;
	}
...
function Rs_S_EX_WRANKING_FESTIVAL_BONUS()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_WRANKING_FESTIVAL_BONUS(packet))
	{
		return;
	}
	if((int(packet.bSuccess) == 1))
...
function Rs_S_EX_WRANKING_FESTIVAL_RANKING()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_WRANKING_FESTIVAL_RANKING(packet))
	{
		return;
	}
...
function Rs_S_EX_WRANKING_FESTIVAL_MY_RECEIVED_BONUS()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_WRANKING_FESTIVAL_MY_RECEIVED_BONUS(packet))
	{
		return;
	}
...
function Rq_C_EX_WRANKING_FESTIVAL_REWARD()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_WRANKING_FESTIVAL_REWARD(stream, packet))
	{
		return;
	}
	packet.dummy = 1;
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(803, stream);
	return;
}
...
function Rs_S_EX_WRANKING_FESTIVAL_REWARD()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_WRANKING_FESTIVAL_REWARD(packet))
	{
		return;
	}
	if((int(packet.bSuccess) == 1))
