...
{
	UIControlGroupButtonAsset = Class'InterfaceClassic.UIControlGroupButtonAssets'.static._InitScript(GetWindowHandle((m_Windowname $ ".UIControlGroupButtonAsset")));
...
{
	Class'InterfaceClassic.HelpWnd'.static.ShowHelp(63, 4);
	return;
}
...
function ParsePacket_S_EX_DETHRONE_DISTRICT_OCCUPATION_INFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_DETHRONE_DISTRICT_OCCUPATION_INFO(packet))
	{
		return;
	}
...
function API_C_EX_DETHRONE_DISTRICT_OCCUPATION_INFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_DETHRONE_DISTRICT_OCCUPATION_INFO(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(718, stream);
