...
function ParsePacket_S_EX_RESULT_PET_EXTRACT_SYSTEM()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_RESULT_PET_EXTRACT_SYSTEM(packet))
	{
		return;
	}
...
function API_C_EX_TRY_PET_EXTRACT_SYSTEM(int nPetItemSID)
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_TRY_PET_EXTRACT_SYSTEM(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(669, stream);
