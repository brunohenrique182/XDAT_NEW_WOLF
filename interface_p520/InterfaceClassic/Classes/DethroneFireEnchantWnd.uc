...
{
	numberInputStepper = Class'InterfaceClassic.UIControlNumberInputSteper'.static.InitScript(GetWindowHandle((m_hOwnerWnd.m_WindowNameWithFullPath $ ".DisableWnd.AutoNumStepPopup.NumberInputSteper")));
...
{
	Class'InterfaceClassic.HelpWnd'.static.ShowHelp(63, 5);
	return;
}
...
{
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_ENHANCED_ABILITY_OF_FIRE_OPEN_UI(OpenUI_Packet))
	{
		return;
	}
...
function API_C_EX_ENHANCED_ABILITY_OF_FIRE_INIT(int cType)
{
	...
	packet.cType = cType;
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_ENHANCED_ABILITY_OF_FIRE_INIT(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(841, stream);
...
function API_C_EX_ENHANCED_ABILITY_OF_FIRE_EXP_UP(int cType)
{
	...
	packet.cType = cType;
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_ENHANCED_ABILITY_OF_FIRE_EXP_UP(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(842, stream);
...
function API_C_EX_ENHANCED_ABILITY_OF_FIRE_LEVEL_UP(int cType)
{
	...
	packet.cType = cType;
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_ENHANCED_ABILITY_OF_FIRE_LEVEL_UP(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(843, stream);
...
{
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(840, _emptyByteArray);
...
{
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(844, _emptyByteArray);
