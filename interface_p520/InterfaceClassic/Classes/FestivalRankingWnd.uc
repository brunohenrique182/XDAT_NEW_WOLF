...
function S_EX_RANKING_FESTIVAL_SIDEBAR_INFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_RANKING_FESTIVAL_SIDEBAR_INFO(packet))
	{
		return;
	}
...
function S_EX_RANKING_FESTIVAL_MYINFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_RANKING_FESTIVAL_MYINFO(packet))
	{
		return;
	}
...
function C_EX_RANKING_FESTIVAL_OPEN()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_RANKING_FESTIVAL_OPEN(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(671, stream);
	return;
}
...
function C_EX_RANKING_FESTIVAL_BUY(int buyID, int ItemNum)
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_RANKING_FESTIVAL_BUY(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(672, stream);
	return;
}
...
function S_EX_RANKING_FESTIVAL_BUY()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_RANKING_FESTIVAL_BUY(packet))
	{
		return;
	}
	C_EX_RANKING_FESTIVAL_MY_RECEIVED_BONUS();
...
function C_EX_RANKING_FESTIVAL_BONUS(array<int> nPoints)
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_RANKING_FESTIVAL_BONUS(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(673, stream);
	return;
}
...
function S_EX_RANKING_FESTIVAL_BONUS()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_RANKING_FESTIVAL_BONUS(packet))
	{
		return;
	}
...
function C_EX_RANKING_FESTIVAL_RANKING(int RankingType)
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_RANKING_FESTIVAL_RANKING(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(674, stream);
	return;
}
...
function S_EX_RANKING_FESTIVAL_RANKING()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_RANKING_FESTIVAL_RANKING(packet))
	{
		return;
	}
...
function C_EX_RANKING_FESTIVAL_MY_RECEIVED_BONUS()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_RANKING_FESTIVAL_MY_RECEIVED_BONUS(stream, packet))
	{
		return;
	}
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(675, stream);
	return;
}
...
function S_EX_RANKING_FESTIVAL_MY_RECEIVED_BONUS()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_RANKING_FESTIVAL_MY_RECEIVED_BONUS(packet))
	{
		return;
	}
...
function C_EX_RANKING_FESTIVAL_REWARD()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Encode_C_EX_RANKING_FESTIVAL_REWARD(stream, packet))
	{
		return;
	}
	packet.dummy = 1;
	Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(676, stream);
	return;
}
...
function S_EX_RANKING_FESTIVAL_REWARD()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_RANKING_FESTIVAL_REWARD(packet))
	{
		return;
	}
	if((int(packet.bSuccess) == 1))
