...
function ShowNpcShowAskDialog()
{
	...
	{
		Class'InterfaceClassic.UICommonAPI'.static.DialogSetID(11122);
...
function API_C_EX_RANKING_CHAR_SPAWN_BUFFZONE_NPC()
{
	...
	{
		Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(598, stream);
...
function API_C_EX_RANKING_CHAR_BUFFZONE_NPC_POSITION()
{
	...
	{
		Class'InterfaceClassic.UIPacket'.static.RequestUIPacket(599, stream);
...
function ParsePacket_S_EX_RANKING_CHAR_BUFFZONE_NPC_INFO()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_RANKING_CHAR_BUFFZONE_NPC_INFO(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_RANKING_CHAR_BUFFZONE_NPC_POSITION()
{
	...
	if(!Class'InterfaceClassic.UIPacket'.static.Decode_S_EX_RANKING_CHAR_BUFFZONE_NPC_POSITION(packet))
	{
		return;
	}
