...
function InitControls()
{
	...
	premiumPurchaseDialog = Class'Interface.UIControlDialogAssets'.static.InitScript(premiumPurchaseDialogWnd);
...
function Rq_C_EX_L2PASS_INFO(L2PassData.EL2PassType PassType)
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_L2PASS_INFO(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(756, stream);
	return;
}
...
function Rq_C_EX_L2PASS_REQUEST_REWARD(L2PassData.EL2PassType PassType, bool IsPremium)
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_L2PASS_REQUEST_REWARD(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(757, stream);
	return;
}
...
function Rq_C_EX_L2PASS_REQUEST_REWARD_ALL(L2PassData.EL2PassType PassType)
{
	...
	packet.cPassType = int(PassType);
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_L2PASS_REQUEST_REWARD_ALL(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(758, stream);
	return;
}
...
function Rq_C_EX_L2PASS_BUY_PREMIUM(L2PassData.EL2PassType PassType)
{
	...
	packet.cPassType = int(PassType);
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_L2PASS_BUY_PREMIUM(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(759, stream);
	return;
}
...
function Rq_C_EX_SAYHAS_SUPPORT_TOGGLE(bool isOn)
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_SAYHAS_SUPPORT_TOGGLE(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(760, stream);
	return;
}
...
function Nt_S_EX_L2PASS_SIMPLE_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_L2PASS_SIMPLE_INFO(packet))
	{
		return;
	}
...
function Rs_S_EX_L2PASS_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_L2PASS_INFO(packet))
	{
		return;
	}
...
function Rs_S_EX_SAYHAS_SUPPORT_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_SAYHAS_SUPPORT_INFO(packet))
	{
		return;
	}
