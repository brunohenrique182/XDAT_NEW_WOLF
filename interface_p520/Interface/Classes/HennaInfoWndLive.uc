...
event OnLoad()
{
	...
	Class'Interface.L2Util'.static.GetEllipsisString(EngraveTxt, 350);
...
function ShowHennaInfoWnd(string param)
{
	...
	if((m_iState == 1))
	{
		...
		if(Class'Interface.L2Util'.static.GetEllipsisString(strDyeName, 315))
		{
		...
		if(Class'Interface.L2Util'.static.GetEllipsisString(strTattooName, 315))
		{
	...
	else if((m_iState == 2))
	{
		...
		if(Class'Interface.L2Util'.static.GetEllipsisString(orignalString, 315))
		{
		...
		if(Class'Interface.L2Util'.static.GetEllipsisString(strDyeName, (315 - textWidth)))
		{
