...
{
	Class'Interface.UICommonAPI'.static.DialogSetID(3300);
	Class'Interface.UICommonAPI'.static.DialogShowWithTarget(DialogModalType_Modal, DialogType_OKCancel, GetSystemMessage(3533), m_Windowname);
	return;
}
...
{
	return Class'Interface.UICommonAPI'.static.InstUICommonAPI().GetRaceString(raceID);
}
