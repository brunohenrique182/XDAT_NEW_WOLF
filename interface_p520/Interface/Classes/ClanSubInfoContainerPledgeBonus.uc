...
function API_C_EX_PLEDGE_DONATION_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_PLEDGE_DONATION_INFO(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(708, stream);
	return;
}
...
function API_C_EX_PLEDGE_DONATION_REQUEST()
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_PLEDGE_DONATION_REQUEST(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(709, stream);
	return;
}
...
function Handle_S_EX_PLEDGE_DONATION_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_PLEDGE_DONATION_INFO(packet))
	{
		return;
	}
...
function Handle_S_EX_PLEDGE_DONATION_REQUEST()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_PLEDGE_DONATION_REQUEST(packet))
	{
		return;
	}
...
{
	needItemListNormalScr = new Class'Interface.UIControlNeedItemList';
	needItemListNormalScr.DelegateOnUpdateItem = HandleOnUpdateItemNormal;
	needItemListFineScr = new Class'Interface.UIControlNeedItemList';
	needItemListFineScr.DelegateOnUpdateItem = HandleOnUpdateItemFine;
	needItemListPremiumlScr = new Class'Interface.UIControlNeedItemList';
