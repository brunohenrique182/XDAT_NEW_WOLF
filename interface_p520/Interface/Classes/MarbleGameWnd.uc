...
function ParsePacket_S_EX_MABLE_GAME_REWARD_ITEM()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_MABLE_GAME_REWARD_ITEM(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_MABLE_GAME_SKILL_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_MABLE_GAME_SKILL_INFO(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_MABLE_GAME_PRISON()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_MABLE_GAME_PRISON(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_MABLE_GAME_MINIGAME()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_MABLE_GAME_MINIGAME(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_MABLE_GAME_SHOW_PLAYER_STATE()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_MABLE_GAME_SHOW_PLAYER_STATE(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_MABLE_GAME_DICE_RESULT()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_MABLE_GAME_DICE_RESULT(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_MABLE_GAME_MOVE()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_MABLE_GAME_MOVE(packet))
	{
		return;
	}
...
function API_C_EX_MABLE_GAME_ROLL_DICE(int cDiceType)
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_MABLE_GAME_ROLL_DICE(stream, packet))
	{
		return;
	}
	bRecover = false;
	currentDiceType = cDiceType;
	Class'Interface.UIPacket'.static.RequestUIPacket(652, stream);
	PlaySound("InterfaceSound.Event.AdenDice_Throw");
...
function API_C_EX_MABLE_GAME_POPUP_OK(int cCellType)
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_MABLE_GAME_POPUP_OK(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(653, stream);
...
function API_C_EX_MABLE_GAME_RESET(int nResetItemType)
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_MABLE_GAME_RESET(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(654, stream);
...
function API_C_EX_MABLE_GAME_CLOSE()
{
	...
	Class'Interface.UIPacket'.static.RequestUIPacket(655, stream);
