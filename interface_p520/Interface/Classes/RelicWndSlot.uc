...
function SetInfo(RelicWnd.RelicInfo Info, optional bool isStaticMode, optional bool isUnkownItem)
{
	...
	{
		slotBtn.SetTooltipCustomType(MakeTooltipSimpleColorText(relicItemInfo.Name, getInstanceL2Util().GetRelicTextColor(ERelicGrade(Info.Data.Grade))));
	}
...
function string GetBackgroundTextureName(UIConstants.ERelicGrade Grade, bool isEnable)
{
	if(isEnable)
	{
		...
		{
			case RG_N:
				return "L2UI_NewTex.RelicWnd.RelicSummonCard_N";
			case RG_D:
				return "L2UI_NewTex.RelicWnd.RelicSummonCard_D";
			case RG_C:
				return "L2UI_NewTex.RelicWnd.RelicSummonCard_C";
			case RG_B:
				return "L2UI_NewTex.RelicWnd.RelicSummonCard_B";
			case RG_A:
				return "L2UI_NewTex.RelicWnd.RelicSummonCard_A";
			default:
				break;
		}
	}
	else
	{
		...
		{
			case RG_N:
				return "L2UI_NewTex.RelicWnd.RelicDisableCard_N";
			case RG_D:
				return "L2UI_NewTex.RelicWnd.RelicDisableCard_D";
			case RG_C:
				return "L2UI_NewTex.RelicWnd.RelicDisableCard_C";
			case RG_B:
				return "L2UI_NewTex.RelicWnd.RelicDisableCard_B";
			case RG_A:
				return "L2UI_NewTex.RelicWnd.RelicDisableCard_A";
			default:
				break;
		}
	}
