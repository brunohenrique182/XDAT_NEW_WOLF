...
function InitUIControlDialogAsset()
{
	...
	uicontrolDialogAssetScr = Class'Interface.UIControlDialogAssets'.static.InitScript(poopExpandWnd);
...
event OnClickButton(string strID)
{
	...
	{
		case "WindowHelp_BTN":
			Class'Interface.HelpWnd'.static.ShowHelp(79);
			break;
		case "WeaponShapeBtn":
...
function SetCurrentPage(int Page)
{
	...
	{
		case 1:
			Class'Interface.CustomizingWndAppearance'.static.Inst().Show();
			Class'Interface.CustomizingWndKillEffect'.static.Inst().Hide();
			Class'Interface.CustomizingWndNameDeco'.static.Inst().Hide();
			TabButtonSetSelect("WeaponShapeBtn");
			break;
		case 2:
			Class'Interface.CustomizingWndAppearance'.static.Inst().Hide();
			Class'Interface.CustomizingWndKillEffect'.static.Inst().Show();
			Class'Interface.CustomizingWndNameDeco'.static.Inst().Hide();
		...
		case 3:
			Class'Interface.CustomizingWndAppearance'.static.Inst().Hide();
			Class'Interface.CustomizingWndKillEffect'.static.Inst().Hide();
			Class'Interface.CustomizingWndNameDeco'.static.Inst().Show();
...
function RT_S_EX_CHARACTER_STYLE_USE_ITEM()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_CHARACTER_STYLE_USE_ITEM(packet))
	{
		return;
	}
	...
	{
		case 1:
			Class'Interface.CustomizingWndAppearance'.static.Inst()._SetSelectByStyleID(packet.nStyleID);
			break;
		case 2:
			Class'Interface.CustomizingWndKillEffect'.static.Inst()._SetSelectByStyleID(packet.nStyleID);
			break;
		case 3:
			Class'Interface.CustomizingWndNameDeco'.static.Inst()._SetSelectByStyleID(packet.nStyleID);
			break;
		default:
			break;
	}
...
function RQ_C_EX_CHARACTER_STYLE_LIST()
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_CHARACTER_STYLE_LIST(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(926, stream);
	return;
}
