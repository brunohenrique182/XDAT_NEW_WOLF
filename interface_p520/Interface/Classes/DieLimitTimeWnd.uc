...
function Handle_S_EX_FIELD_DIE_LIMT_TIME()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_FIELD_DIE_LIMT_TIME(packet))
	{
		return;
	}
...
function Handle_S_EX_TIME_RESTRICT_FIELD_DIE_LIMT_TIME()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_TIME_RESTRICT_FIELD_DIE_LIMT_TIME(packet))
	{
		return;
	}
	times = packet.nDieLimitTime;
