...
function InitControls()
{
	...
	dialogAsset = Class'Interface.UIControlDialogAssets'.static.InitScript(dialogWnd);
...
function InitSlotControls()
{
	...
	while((i < maxSlotNum))
	{
		...
		slotObject = new Class'Interface.CrossEventWndSlot';
...
{
	Class'Interface.CrossEventRewardListWnd'.static.Inst().ToggleShowWnd();
	return;
}

function HideRareRewardListWnd()
{
	Class'Interface.CrossEventRewardListWnd'.static.Inst().CloseWnd();
	return;
}
...
function Rq_C_EX_CROSS_EVENT_DATA()
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_CROSS_EVENT_DATA(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(876, stream);
...
function Rq_C_EX_CROSS_EVENT_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_CROSS_EVENT_INFO(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(877, stream);
...
function Rq_C_EX_CROSS_EVENT_NORMAL_REWARD()
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_CROSS_EVENT_NORMAL_REWARD(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(878, stream);
...
function Rq_C_EX_CROSS_EVENT_RARE_REWARD()
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_CROSS_EVENT_RARE_REWARD(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(879, stream);
	StartButtonDelayTimer();
	return;
}
...
function Rq_C_EX_CROSS_EVENT_RESET()
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_CROSS_EVENT_RESET(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(880, stream);
	return;
}
...
function Rs_S_EX_CROSS_EVENT_DATA()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_CROSS_EVENT_DATA(packet))
	{
		return;
	}
	...
	Class'Interface.CrossEventRewardListWnd'.static.Inst().SetInfo(packet.rareRewards);
...
function Rs_S_EX_CROSS_EVENT_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_CROSS_EVENT_INFO(packet))
	{
		return;
	}
...
function Rs_S_EX_CROSS_EVENT_NORMAL_REWARD()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_CROSS_EVENT_NORMAL_REWARD(packet))
	{
		return;
	}
...
function Rs_S_EX_CROSS_EVENT_RARE_REWARD()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_CROSS_EVENT_RARE_REWARD(packet))
	{
		return;
	}
	if((int(packet.bSuccess) == 1))
...
function Rs_S_EX_CROSS_EVENT_RESET()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_CROSS_EVENT_RESET(packet))
	{
		return;
	}
	if((int(packet.bSuccess) == 1))
...
function Nt_S_EX_CROSS_EVENT_NOTI()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_CROSS_EVENT_NOTI(packet))
	{
		return;
	}
