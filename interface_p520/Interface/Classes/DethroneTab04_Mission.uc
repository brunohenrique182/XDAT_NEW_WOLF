...
function ParsePacket_S_EX_DETHRONE_DAILY_MISSION_GET_REWARD()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_DETHRONE_DAILY_MISSION_GET_REWARD(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_DETHRONE_DAILY_MISSION_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_DETHRONE_DAILY_MISSION_INFO(packet))
	{
		return;
	}
...
function API_C_EX_DETHRONE_DAILY_MISSION_INFO()
{
	...
	Class'Interface.UIPacket'.static.RequestUIPacket(719, stream);
...
function API_C_EX_DETHRONE_DAILY_MISSION_GET_REWARD(int nMissionID)
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_DETHRONE_DAILY_MISSION_GET_REWARD(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(720, stream);
