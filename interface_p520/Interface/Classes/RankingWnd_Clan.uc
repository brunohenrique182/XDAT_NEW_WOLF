...
function ParsePacket_S_EX_PLEDGE_RANKING_MY_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_PLEDGE_RANKING_MY_INFO(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_PLEDGE_RANKING_LIST()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_PLEDGE_RANKING_LIST(packet))
	{
		return;
	}
...
function API_C_EX_PLEDGE_RANKING_MY_INFO()
{
	...
	packet.cDummy = 0;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_PLEDGE_RANKING_MY_INFO(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(711, stream);
...
function API_C_EX_PLEDGE_RANKING_LIST()
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_PLEDGE_RANKING_LIST(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(712, stream);
