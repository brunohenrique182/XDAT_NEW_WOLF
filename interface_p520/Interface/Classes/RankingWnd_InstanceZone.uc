...
function Rq_C_EX_INZONE_RANKING_MY_INFO(int RankingID)
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_INZONE_RANKING_MY_INFO(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(851, stream);
	return;
}
...
function Rq_C_EX_INZONE_RANKING_LIST(int RankingID, int RankingScope, bool bCurrentSeason)
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_INZONE_RANKING_LIST(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(852, stream);
	return;
}
...
function Rs_S_EX_INZONE_RANKING_MY_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_INZONE_RANKING_MY_INFO(packet))
	{
		return;
	}
...
function Rs_S_EX_INZONE_RANKING_LIST()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_INZONE_RANKING_LIST(packet))
	{
		return;
	}
