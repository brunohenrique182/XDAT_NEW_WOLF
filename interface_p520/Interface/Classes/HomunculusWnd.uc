...
function API_C_EX_SHOW_HOMUNCULUS_INFO(int Type)
{
	...
	packet.Type = Type;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_SHOW_HOMUNCULUS_INFO(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(633, stream);
	return;
}
...
function API_C_EX_HOMUNCULUS_ACTIVATE_SLOT(int SlotIndex)
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_HOMUNCULUS_ACTIVATE_SLOT(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(702, stream);
	return;
}
...
function API_C_EX_HOMUNCULUS_CREATE_START()
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_HOMUNCULUS_CREATE_START(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(634, stream);
	return;
}
...
function API_C_EX_HOMUNCULUS_INSERT(int Type)
{
	...
	packet.Type = Type;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_HOMUNCULUS_INSERT(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(635, stream);
	return;
}
...
function API_C_EX_HOMUNCULUS_SUMMON()
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_HOMUNCULUS_SUMMON(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(636, stream);
	return;
}
...
function API_C_EX_DELETE_HOMUNCULUS_DATA(int idx)
{
	...
	packet.nIdx = idx;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_DELETE_HOMUNCULUS_DATA(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(637, stream);
	return;
}
...
function API_C_EX_REQUEST_ACTIVATE_HOMUNCULUS(int idx, bool bActive)
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_REQUEST_ACTIVATE_HOMUNCULUS(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(638, stream);
	return;
}
...
function API_C_EX_HOMUNCULUS_ENCHANT_EXP(int idx)
{
	...
	packet.nIdx = idx;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_HOMUNCULUS_ENCHANT_EXP(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(643, stream);
	return;
}
...
function API_C_EX_HOMUNCULUS_GET_ENCHANT_POINT(int Type)
{
	...
	packet.Type = Type;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_HOMUNCULUS_GET_ENCHANT_POINT(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(639, stream);
	return;
}
...
function API_C_EX_HOMUNCULUS_INIT_POINT(int Type)
{
	...
	packet.Type = Type;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_HOMUNCULUS_INIT_POINT(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(640, stream);
	return;
}
...
function API_C_EX_ENCHANT_HOMUNCULUS_SKILL(int Type, int idx, int Level)
{
	...
	packet.nIdx = idx;
	packet.nLevel = Level;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_ENCHANT_HOMUNCULUS_SKILL(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(642, stream);
	return;
}
