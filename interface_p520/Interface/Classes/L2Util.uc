...
function bool IsPeroidSortCheck(ItemInfo iInfoA, ItemInfo iInfoB)
{
	...
	isPeroidicItemA = Class'Interface.L2UIInventory'.static.Inst()._IsPeroidicItem(iInfoA);
	isPeroidicItemB = Class'Interface.L2UIInventory'.static.Inst()._IsPeroidicItem(iInfoB);
...
function SortItemClassic(ItemWindowHandle m_topList)
{
	...
	if((ItemListAll.Length > 0))
	{
		sortObject = new Class'Interface.L2UISortObject';
...
static function bool SetEllipsisTextBox(TextBoxHandle tbh, optional int MaxW)
{
	...
	Str = tbh.GetText();
	if(Class'Interface.L2Util'.static.GetEllipsisString(Str, MaxW))
	{
