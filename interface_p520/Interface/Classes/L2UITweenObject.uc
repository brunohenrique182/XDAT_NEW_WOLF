...
function _Play(optional int _delay)
{
	...
	Paused = false;
	if((Class'Interface.L2UITween'.static.Inst()._GetTweenObjectIndex(Owner, Id) < 0))
	{
		Class'Interface.L2UITween'.static.Inst()._AddTweenObject(self);
	}
	return;
}
...
function _Kill()
{
	Class'Interface.L2UITween'.static.Inst().StopTween(Owner, Id);
	return;
}
