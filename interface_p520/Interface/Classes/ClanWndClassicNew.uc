...
event OnClickButton(string strID)
{
	...
	{
		Class'Interface.HelpWnd'.static.ShowHelp(147);
	}
...
function API_C_EX_PLEDGE_V3_SET_ANNOUNCE()
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_PLEDGE_V3_SET_ANNOUNCE(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(670, stream);
	return;
}
...
function API_C_EX_PLEDGE_V3_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_PLEDGE_V3_INFO(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(665, stream);
	return;
}
...
function Handle_S_EX_PLEDGE_V3_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_PLEDGE_V3_INFO(packet))
	{
		return;
	}
...
function InitUIControlDialogAsset()
{
	...
	Class'Interface.UIControlDialogAssets'.static.InitScript(poopExpandWnd);
	return;
}
