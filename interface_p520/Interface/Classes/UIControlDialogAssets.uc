...
function InitNeedItem()
{
	...
	_initNeedItem = true;
	needItemScript = Class'Interface.UIControlNeedItemList'.static.InitScript(GetWindowHandle(m_WindowNameNeedItem));
...
function InitInputControl()
{
	...
	inputItemScript = Class'Interface.UIControlNumberInput'.static.InitScript(inputItemWnd);
...
function SetTextBoxHeight(string Desc, optional int HeightOffset)
{
	...
	Height = Class'Interface.L2Util'.static.Inst()._GetTextBoxHeight(DescriptionTextBox, Desc);
	if((HeightOffset > 0))
	{
