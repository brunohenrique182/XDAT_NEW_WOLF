...
function ParsePacket_S_EX_CRAFT_RANDOM_MAKE()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_CRAFT_RANDOM_MAKE(packet))
	{
		return;
	}
	if((packet.cResult == 0))
...
function ParsePacket_S_EX_CRAFT_RANDOM_INFO(optional bool bUpdate)
{
	...
	{
		if(!Class'Interface.UIPacket'.static.Decode_S_EX_CRAFT_RANDOM_INFO(packet))
		{
			return;
		}
...
function ParsePacket_S_EX_CRAFT_RANDOM_LOCK_SLOT()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_CRAFT_RANDOM_LOCK_SLOT(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_CRAFT_RANDOM_REFRESH()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_CRAFT_RANDOM_REFRESH(packet))
	{
		return;
	}
...
function API_C_EX_CRAFT_RANDOM_REFRESH()
{
	...
	Class'Interface.UIPacket'.static.RequestUIPacket(622, stream);
...
function API_C_EX_CRAFT_RANDOM_MAKE()
{
	...
	Class'Interface.UIPacket'.static.RequestUIPacket(623, stream);
...
function API_C_EX_CRAFT_RANDOM_INFO()
{
	...
	Class'Interface.UIPacket'.static.RequestUIPacket(620, stream);
...
function API_C_EX_CRAFT_RANDOM_LOCK_SLOT(int nSlot)
{
	...
	packet.nSlot = nSlot;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_CRAFT_RANDOM_LOCK_SLOT(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(621, stream);
