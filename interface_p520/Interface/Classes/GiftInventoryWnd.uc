...
function ParsePacket_S_EX_GOODS_GIFT_LIST_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_GOODS_GIFT_LIST_INFO(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_GOODS_GIFT_ACCEPT_RESULT()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_GOODS_GIFT_ACCEPT_RESULT(packet))
	{
		return;
	}
...
function ParsePacket_S_EX_GOODS_GIFT_REFUSE_RESULT()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_GOODS_GIFT_REFUSE_RESULT(packet))
	{
		return;
	}
...
function API_C_EX_GOODS_GIFT_LIST_INFO()
{
	...
	Class'Interface.UIPacket'.static.RequestUIPacket(809, stream);
...
function API_C_EX_GOODS_GIFT_ACCEPT(INT64 nPurchaseId, INT64 nGoodsDeliveryRequestId)
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_GOODS_GIFT_ACCEPT(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(810, stream);
...
function API_C_EX_GOODS_GIFT_REFUSET(INT64 nPurchaseId, INT64 nGoodsDeliveryRequestId)
{
	...
	packet.nPurchaseId = nPurchaseId;
	packet.nGoodsDeliveryRequestId = nGoodsDeliveryRequestId;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_GOODS_GIFT_REFUSE(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(811, stream);
