...
{
	uicontrolFindTextInputScr = Class'Interface.UIControlTextInput'.static.InitScript(GetWindowHandle((m_hOwnerWnd.m_WindowNameWithFullPath $ ".FindTextInput")));
	...
	uicontrolExecptionTextInputScr = Class'Interface.UIControlTextInput'.static.InitScript(GetWindowHandle((m_hOwnerWnd.m_WindowNameWithFullPath $ ".execptionTextInput")));
...
event OnRClickListCtrlRecord(string strID)
{
	...
	Class'Interface.L2Util'.static.Inst().showGfxScreenMessage(ShowMsg);
...
function InsertRecordFindTreeList()
{
	...
	AddRichListCtrlString(rowData.cellDataList[0].drawitems, fullNameString, Class'Interface.L2Util'.static.Inst().White, false, 5, 9);
	if(getInstanceUIData().GetIsClassicServer())
	{
		AddRichListCtrlString(rowData.cellDataList[0].drawitems, "Lv", Class'Interface.L2Util'.static.Inst().Yellow, false, 5);
		AddRichListCtrlString(rowData.cellDataList[0].drawitems, string(lastSkillLevel), Class'Interface.L2Util'.static.Inst().Yellow, false, 2);
	}
	else
	{
		AddRichListCtrlString(rowData.cellDataList[0].drawitems, "Lv", Class'Interface.L2Util'.static.Inst().Gray, false, 5);
		AddRichListCtrlString(rowData.cellDataList[0].drawitems, string(lastSkillLevel), Class'Interface.L2Util'.static.Inst().Gold, false, 2);
	}
	AddRichListCtrlString(rowData.cellDataList[1].drawitems, string(lastSkillLevel), Class'Interface.L2Util'.static.Inst().White, false, 10);
	if((lastSubSkillInfo > 0))
	{
		AddRichListCtrlString(rowData.cellDataList[2].drawitems, string(lastSubSkillInfo), Class'Interface.L2UIColor'.static.Inst().VIOLET01, false, 10);
	}
	else
	{
		AddRichListCtrlString(rowData.cellDataList[2].drawitems, string(lastSubSkillInfo), Class'Interface.L2Util'.static.Inst().Gray, false, 10);
	}
	AddRichListCtrlString(rowData.cellDataList[3].drawitems, string(lastSkillClassiD), Class'Interface.L2UIColor'.static.Inst().White, false);
