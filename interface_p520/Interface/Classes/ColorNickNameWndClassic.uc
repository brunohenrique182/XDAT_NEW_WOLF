...
function ParsePacket_S_EX_CHANGE_NICKNAME_COLOR_ICON()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_CHANGE_NICKNAME_COLOR_ICON(packet))
	{
		return;
	}
...
function API_C_EX_CHANGE_NICKNAME_COLOR_ICON(int nItemClassID, int nColorIndex, string sNickName)
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_CHANGE_NICKNAME_COLOR_ICON(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(729, stream);
