...
function string GetResultSlotTextureName(UIConstants.ERelicGrade Grade)
{
	...
	{
		case RG_N:
			return "L2UI_NewTex.RelicWnd.CombineCard_DN";
		case RG_D:
			return "L2UI_NewTex.RelicWnd.CombineCard_CD";
		case RG_C:
			return "L2UI_NewTex.RelicWnd.CombineCard_BC";
		case RG_B:
			return "L2UI_NewTex.RelicWnd.CombineCard_AB";
		case RG_A:
			return "L2UI_NewTex.RelicWnd.CombineCard_AS";
		default:
			return "";
	}
}
