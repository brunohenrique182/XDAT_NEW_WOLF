...
function OnLoad()
{
	L2UIInventoryFindByCompare = new Class'Interface.L2UIInventoryObjectFindByCompare';
	return;
}
...
function L2UIInventoryObjectSimple NewObjectSimple(int ClassID, optional int ServerID, optional int Index)
{
	...
	inventoryObjectsSimple[Len] = new Class'Interface.L2UIInventoryObjectSimple';
...
{
	inventoryObjects[inventoryObjects.Length] = new Class'Interface.L2UIInventoryObject';
