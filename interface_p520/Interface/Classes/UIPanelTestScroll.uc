...
function Initialize()
{
	scrollTesterV = Class'Interface.UIControlTilelistScroll'.static.InitScript(GetWindowHandle((m_hOwnerWnd.m_WindowNameWithFullPath $ ".ScrollAreaWndV")), 2, 5, true, "renderer");
	...
	scrollTesterV2 = Class'Interface.UIControlTilelistScroll'.static.InitScript(GetWindowHandle((m_hOwnerWnd.m_WindowNameWithFullPath $ ".ScrollAreaWndV2")), 1, 4, true, "renderer");
	...
	scrollTester = Class'Interface.UIControlTilelistScroll'.static.InitScript(GetWindowHandle((m_hOwnerWnd.m_WindowNameWithFullPath $ ".ScrollAreaWnd")), 5, 2, false, "renderer");
...
function PlayAnimTextureHandle(string BTNID, int rendererIndex, int itemIndex)
{
	...
	rotateTObject = Class'Interface.L2UITween'.static.Inst()._AddTweenRotate(GetAnimTextureHandle((scrollTesterV._GetRendererPath(rendererIndex) $ ".circleEffect")), 9, 370.0000000, 2000.0000000);
	rotateTObject._Play();
	return;
}
