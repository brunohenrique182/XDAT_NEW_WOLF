...
function C_EX_COLLECTION_SUMMARY()
{
	...
	packet.cDummy = 1;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_COLLECTION_SUMMARY(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(689, stream);
	return;
}
...
function API_C_EX_COLLECTION_LIST(int Category, optional LIST_REQUESTEDMODE _requestedMode)
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_COLLECTION_LIST(stream, packet))
	{
		return;
	}
	requestedMode = _requestedMode;
	Class'Interface.UIPacket'.static.RequestUIPacket(686, stream);
	return;
}
...
function API_C_EX_COLLECTION_FAVORITE_LIST(optional LIST_REQUESTEDMODE _requestedMode)
{
	...
	packet.cDummy = 0;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_COLLECTION_FAVORITE_LIST(stream, packet))
	{
		return;
	}
	requestedMode = _requestedMode;
	Class'Interface.UIPacket'.static.RequestUIPacket(688, stream);
	return;
}
...
function API_C_EX_COLLECTION_OPEN_UI()
{
	...
	packet.cDummy = 0;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_COLLECTION_OPEN_UI(stream, packet))
	{
		return;
	}
	if((Class'Interface.ItemAutoPeelWnd'.static.Inst().IsItemPeeling() == true))
	{
	...
	Class'Interface.UIPacket'.static.RequestUIPacket(684, stream);
	return;
}
...
function API_C_EX_COLLECTION_CLOSE_UI()
{
	...
	packet.cDummy = 0;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_COLLECTION_CLOSE_UI(stream, packet))
	{
		return;
	}
	SideBar(GetScript("SideBar")).SideBarLockVOption(false);
	Class'Interface.UIPacket'.static.RequestUIPacket(685, stream);
	return;
}
...
function API_C_EX_COLLECTION_REGISTER(int nCollectionID, int nSlotNumber, int nItemSid)
{
	...
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_COLLECTION_REGISTER(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(690, stream);
	return;
}
...
function API_C_EX_COLLECTION_RECEIVE_REWARD(int nCollectionID)
{
	...
	packet.nCollectionID = nCollectionID;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_COLLECTION_RECEIVE_REWARD(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(691, stream);
	return;
}
...
function API_C_EX_COLLECTION_UPDATE_FAVORITE(bool bRegister, int nCollectionID)
{
	...
	packet.nCollectionID = nCollectionID;
	if(!Class'Interface.UIPacket'.static.Encode_C_EX_COLLECTION_UPDATE_FAVORITE(stream, packet))
	{
		return;
	}
	Class'Interface.UIPacket'.static.RequestUIPacket(687, stream);
	return;
}
...
function S_EX_COLLECTION_CLOSE_UI()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_COLLECTION_CLOSE_UI(packet))
	{
		return;
	}
...
function S_EX_COLLECTION_OPEN_UI()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_COLLECTION_OPEN_UI(packet))
	{
		return;
	}
