...
{
	TopGroupButtonAsset = Class'Interface.UIControlGroupButtonAssets'.static._InitScript(GetWindowHandle((m_Windowname $ ".UIControlGroupButtonAsset1")));
...
{
	uicontrolTextInputScr = Class'Interface.UIControlTextInput'.static.InitScript(GetWindowHandle((m_Windowname $ ".ItemFind_Wnd.TextInput")));
...
function SetPopupScript()
{
	...
	popupExpandScript = Class'Interface.UIControlDialogAssets'.static.InitScript(GetWindowHandle((m_Windowname $ ".UIControlDialogAsset")));
