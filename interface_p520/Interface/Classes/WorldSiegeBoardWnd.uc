...
function Initialize()
{
	...
	mapObjOccupy = new Class'Interface.UIMapInt64Object';
	mapObjHeroWeapon = new Class'Interface.UIMapInt64Object';
	mapObjHeroWeaponUser = new Class'Interface.UIMapInt64Object';
	mapObjGolem = new Class'Interface.UIMapInt64Object';
	return;
}
...
function InitWorldSiegeBoardOcptnObjects()
{
	...
	{
		worldSiegeBoardOcptnObjects[i] = Class'Interface.WorldSiegeBoardOcptnObject'.static.InitScript(GetWindowHandle(((m_Windowname $ ".WorldSegeMapWnd.Icon_ocptnObjectWnd") $ Int2Str(i))), i);
...
function Handle_S_EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_OCCUPY_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_OCCUPY_INFO(packet))
	{
		return;
	}
...
function Handle_S_EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HERO_WEAPON_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HERO_WEAPON_INFO(packet))
	{
		return;
	}
	if(!ChkCastleID(packet.nCastleID))
...
function Handle_S_EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HERO_WEAPON_USER()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HERO_WEAPON_USER(packet))
	{
		return;
	}
	if(!ChkCastleID(packet.nCastleID))
...
function SetHeroWeaponUserInfos(array<UIPacket._WorldCastleWar_MainBattleHeroWeaponUserInfo> heroWeaponUserInfos)
{
	...
	usedKey = new Class'Interface.UIMapInt64Object';
	i = 0;
...
function Handle_S_EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_SIEGE_GOLEM_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_SIEGE_GOLEM_INFO(packet))
	{
		return;
	}
	if(!ChkCastleID(packet.nCastleID))
...
function Handle_S_EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_DOOR_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_DOOR_INFO(packet))
	{
		return;
	}
	if(!ChkCastleID(packet.nCastleID))
...
function Handle_S_EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HUD_INFO()
{
	...
	if(!Class'Interface.UIPacket'.static.Decode_S_EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HUD_INFO(packet))
	{
		return;
	}
	if(!ChkCastleID(packet.nCastleID))
...
function API_C_EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HUD_INFO()
{
	...
	if(Class'Interface.UIPacket'.static.Encode_C_EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HUD_INFO(stream, packet))
	{
		Class'Interface.UIPacket'.static.RequestUIPacket(745, stream);
	}
	return;
}
