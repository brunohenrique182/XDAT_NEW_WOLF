...
/**
 * Wolf Waker / p520 Font.
 *
 * p520 adds a system edit-box font name between defaultFontName and
 * defaultColor. Without it the legacy schema interprets string bytes as the
 * font-list count.
 */
@DefaultIO
@CompileDynamic
class Font implements IOEntity {
    ...
    static class FontData implements IOEntity {
        ...
        int shadow_x
        int shadow_y
        transient int unused01
        transient int unused02
        boolean stroke = false
        boolean stroke_large = false
        transient int unused11
        int lineGap
        int underlineOffset
