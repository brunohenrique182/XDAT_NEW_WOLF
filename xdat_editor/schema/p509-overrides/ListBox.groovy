...
/**
 * Wolf Waker / p520 ListBox.
 *
 * Binary-validated against all 8 ListBox instances in both supplied p520 XDAT
 * files. p520 appends three scrollbar texture strings to the etoa5 layout.
 */
@Bindable
@DefaultIO
@CompileDynamic
